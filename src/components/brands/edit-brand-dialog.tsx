/**
 * @file edit-brand-dialog.tsx
 * @description Dialog modal for updating an existing brand entity.
 */
...
import { useUpdateBrandMutation } from "@/hooks/use-brand-query"
import type { Brand, BrandStatus, UpdateBrandPayload } from "@/types/brand"

export interface EditBrandDialogProps {
  brand: Brand | null
  open: boolean
...
export function EditBrandDialog({
  ...
  const [formData, setFormData] = React.useState<UpdateBrandPayload>({
    name: "",
    slug: "",
    logoUrl: "",
    description: "",
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <DialogDescription className="text-xs text-muted-foreground mt-0.5">
                  Update brand profile, logo URL, and publishing status.
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4 text-xs">
            ...
            <ImageUploadDropzone
              ...
              folder="/brands"
              label="Brand Logo"
              description="Upload updated brand logo from device (PNG, JPG, SVG, WebP)"
              aspectRatio="square"
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                placeholder="Description of the brand and catalog line..."
                rows={3}
